...
export const programa: Dia[] = [
  {
    ...
    items: [
      ...
      { tipo: 'titulo', texto: 'Reunión Nacional de Ramas' },
      {
        ...
        subitems: [
          ...
          },
          {
            ...
            detalle: 'Dr. Fabián Pérez · Consejero de la Rama Estudiantil EPN',
          },
          {
            hora: '9H30 – 9H45',
      ...
      { tipo: 'pausa', texto: '12H45 – 14H30 · Almuerzo' },
      { tipo: 'pausa', texto: '14H30 – 15H00 · Traslado - CEC' },
      {
        tipo: 'sesion',
        hora: '15H00 – 16H00',
      ...
      { tipo: 'sesion', hora: '22H00 – 23H00', titulo: 'Retorno al hotel' },
    ],
  },
  {
    numero: 'Día 2',
    ...
    items: [
      ...
      { tipo: 'pausa', texto: '11H15 – 11H30 · Break' },
      {
        ...
        hora: '11H30 – 12H30',
        titulo: 'Charla',
        detalle: 'MSc. Alcibar Yánez · Dr. Julio Barzola · Tesorería IEEE Ecuador Section',
      },
      {
        tipo: 'sesion',
        hora: '12H30 – 13H00',
        titulo: 'Charla de premios',
        detalle: 'Ing. Marco Vinueza · Pasado Vicepresidente Rama EPN',
      },
      { tipo: 'pausa', texto: '13H00 – 14H30 · Almuerzo' },
      { tipo: 'pausa', texto: '14H30 – 15H00 · Traslado - CEC' },
